...
const UserDetail = () => {
    ...
    const fetchUserData = async () => {
        try {
            const response = await api.get(`/api/req/user/${id}`);
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center">
                            ...
                            <div>
                                <Title level={2} className="m-0 text-gray-800">Kullanıcı Detayları</Title>
                                <Text type="secondary">Kullanıcı bilgileri ve stok durumu</Text>
                            </div>
                        </div>
                    </div>
                </div>
