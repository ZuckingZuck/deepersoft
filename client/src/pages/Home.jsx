      ...
      <div className="mb-6">
        ...
        >
          {projectsLoading ? (
            ...
            <div className="space-y-4">
              {recentProjects.reverse().map((project, index) => (
                <div key={project._id} className="p-4 hover:bg-gray-50 rounded-xl transition-colors">
                  ...
                  <div id='wrapper2' className='flex gap-3'>
                    <div className="flex items-center text-gray-500 text-sm mt-2">
                      <SwapLeftOutlined className="mr-1" />
                      <Text type="secondary">Kazanç: {project.totalPrice.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })}</Text>
                    </div>
                    <div className="flex items-center text-gray-500 text-sm mt-2">
                      <SwapRightOutlined className="mr-1" />
                      <Text type="secondary">Taşeron Kazanç: {project.totalContractorPrice.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })}</Text>
                    </div>
                  </div>
